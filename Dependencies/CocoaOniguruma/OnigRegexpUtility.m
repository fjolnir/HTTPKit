...
{
    return [self replaceByRegexp:pattern withCallback:stringReplaceCallback data:(void*)string selector:NULL];
}

- (NSString*)replaceByRegexp:(id)pattern withBlock:(NSString* (^)(OnigResult*))block
{
    return [self replaceByRegexp:pattern withCallback:blockReplaceCallback data:(void*)block selector:NULL];
}
...
{
    return [self replaceAllByRegexp:pattern withCallback:stringReplaceCallback data:(void*)string selector:NULL];
}

- (NSString*)replaceAllByRegexp:(id)pattern withBlock:(NSString* (^)(OnigResult*))block
{
    return [self replaceAllByRegexp:pattern withCallback:blockReplaceCallback data:(void*)block selector:NULL];
}
